...
/**
 * ShipmentTrackingNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentTrackingNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_trackingNumbers_inner';
    ...
    */
     ...
     * Sets tn
     *
     * @param string|null $tn Tracking number.
     *
     * @return self
     */
    ...
    {
        if (is_null($tn)) {
            throw new \InvalidArgumentException('non-nullable tn cannot be null');
        }
