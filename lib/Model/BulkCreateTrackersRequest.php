...
/**
 * BulkCreateTrackersRequest Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class BulkCreateTrackersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulk-create-trackers-request';
    ...
    protected static $openAPITypes = [
        'trackers' => '\Ship24\TrackingApi\Model\TrackerCreateRequest[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['trackers'] === null) {
            $invalidProperties[] = "'trackers' can't be null";
        }
     ...
     * Sets trackers
     *
     * @param \Ship24\TrackingApi\Model\TrackerCreateRequest[] $trackers trackers
     *
     * @return self
     */
