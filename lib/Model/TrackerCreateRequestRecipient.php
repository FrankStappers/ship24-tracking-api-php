...
/**
 * TrackerCreateRequestRecipient Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class TrackerCreateRequestRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'tracker_create_request_recipient';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Recipient email, used for optional email notifications.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Recipient name, used for optional email notifications.
     *
     * @return self
     */
