...
/**
 * ShipmentDelivery Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class ShipmentDelivery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'shipment_delivery';
    ...
    */
     ...
     *
     * @param \DateTime|null $estimated_delivery_date Estimated delivery date of the shipment, if provided by the courier. Format: [Date and Time in UTC](http://docs.ship24.com/data-format#logistics-date-and-time)
     *
     * @return self
     */
     ...
     * Sets service
     *
     * @param string|null $service Name of logistics service or product for the shipment.
     *
     * @return self
     */
     ...
     * Sets signed_by
     *
     * @param string|null $signed_by Name of the person who signed for the shipment.
     *
     * @return self
     */
