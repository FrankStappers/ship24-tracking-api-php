...
/**
 * GetCouriers200ResponseData Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class GetCouriers200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_couriers_200_response_data';
    ...
    protected static $openAPITypes = [
        'couriers' => '\Ship24\TrackingApi\Model\GetCouriers200ResponseDataCouriersInner[]'
    ];
    ...
    {
        $this->setIfExists('couriers', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets couriers
     *
     * @return \Ship24\TrackingApi\Model\GetCouriers200ResponseDataCouriersInner[]|null
     */
     ...
     * Sets couriers
     *
     * @param \Ship24\TrackingApi\Model\GetCouriers200ResponseDataCouriersInner[]|null $couriers couriers
     *
     * @return self
     */
    ...
    {
        if (is_null($couriers)) {
            throw new \InvalidArgumentException('non-nullable couriers cannot be null');
        }
