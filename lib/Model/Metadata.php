...
class Metadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets generated_at
     *
     * @param \DateTime|null $generated_at Date at which the webhook data was generated.
     *
     * @return self
     */
     ...
     * Sets message_id
     *
     * @param string|null $message_id Unique identifier of the tracking object across webhooks.
     *
     * @return self
     */
