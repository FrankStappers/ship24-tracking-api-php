...
/**
 * ResendWebhooks201ResponseDataSummary Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class ResendWebhooks201ResponseDataSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'resend_webhooks_201_response_data_summary';
    ...
    {
        $this->setIfExists('total_resent', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getTotalResent()
    {
        return $this->container['total_resent'];
    }

    /**
     * Sets total_resent
     *
     * @param string|null $total_resent The total number of events resent.
     *
     * @return self
     */
    public function setTotalResent($total_resent)
    {
        if (is_null($total_resent)) {
            throw new \InvalidArgumentException('non-nullable total_resent cannot be null');
        }
        $this->container['total_resent'] = $total_resent;
