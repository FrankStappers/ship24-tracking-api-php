...
/**
 * GetTrackingRequest Class Doc Comment
 *
 * @category Class
 * @package  Ship24\TrackingApi
 * @author   OpenAPI Generator team
 ...
 */
class GetTrackingRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_tracking_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['tracking_number']) && (mb_strlen($this->container['tracking_number']) > 50)) {
            $invalidProperties[] = "invalid value for 'tracking_number', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['tracking_number']) && (mb_strlen($this->container['tracking_number']) < 5)) {
            $invalidProperties[] = "invalid value for 'tracking_number', the character length must be bigger than or equal to 5.";
        }

        if (!is_null($this->container['tracking_number']) && !preg_match("/^[a-zA-Z0-9-_\/.]*$/", $this->container['tracking_number'])) {
     ...
     *
     * @param string|null $tracking_number Tracking number of the shipment.
     *
     * @return self
     */
    public function setTrackingNumber($tracking_number)
    {
        ...
        if ((mb_strlen($tracking_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling GetTrackingRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($tracking_number) < 5)) {
            throw new \InvalidArgumentException('invalid length for $tracking_number when calling GetTrackingRequest., must be bigger than or equal to 5.');
        }
        if ((!preg_match("/^[a-zA-Z0-9-_\/.]*$/", ObjectSerializer::toString($tracking_number)))) {
            throw new \InvalidArgumentException("invalid value for \$tracking_number when calling GetTrackingRequest., must conform to the pattern /^[a-zA-Z0-9-_\/.]*$/.");
        }
     ...
     * Sets courier_code
     *
     * @param mixed[]|null $courier_code Code of the courier(s) handling the shipment (Up to 3 max) (see Couriers list section)  - 📌 Recommended to improve tracking accuracy
     *
     * @return self
     */
