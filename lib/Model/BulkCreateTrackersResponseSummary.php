...
/**
 * BulkCreateTrackersResponseSummary Class Doc Comment
 *
 * @category Class
 ...
 */
class BulkCreateTrackersResponseSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'bulk_create_trackers_response_summary';
    ...
    protected static $setters = [
        'total_inputs' => 'setTotalInputs',
        'total_created' => 'setTotalCreated',
        'total_existing' => 'setTotalExisting',
    ...
    protected static $getters = [
        'total_inputs' => 'getTotalInputs',
        'total_created' => 'getTotalCreated',
        'total_existing' => 'getTotalExisting',
    ...
    {
        $this->setIfExists('total_inputs', $data ?? [], null);
        $this->setIfExists('total_created', $data ?? [], null);
        $this->setIfExists('total_existing', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['total_inputs'];
    }

    /**
     * Sets total_inputs
     *
     * @param int|null $total_inputs Total number of trackers to create.
     *
     * @return self
     */
    public function setTotalInputs($total_inputs)
    {
        if (is_null($total_inputs)) {
            throw new \InvalidArgumentException('non-nullable total_inputs cannot be null');
        }
        $this->container['total_inputs'] = $total_inputs;
     ...
     * Sets total_created
     *
     * @param int|null $total_created Total number of trackers created.
     *
     * @return self
     */
    ...
    {
        return $this->container['total_existing'];
    }

    /**
     * Sets total_existing
     *
     * @param int|null $total_existing Total number of already existing trackers.
     *
     * @return self
     */
    public function setTotalExisting($total_existing)
    {
        if (is_null($total_existing)) {
            throw new \InvalidArgumentException('non-nullable total_existing cannot be null');
        }
        $this->container['total_existing'] = $total_existing;
     ...
     * Sets total_errors
     *
     * @param int|null $total_errors Total number of errors (failed creations).
     *
     * @return self
     */
